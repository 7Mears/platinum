 ...
 */
    ...
    proto.staticClick = function(event, pointer) {
        ...
        var clickedCellIndex = clickedCell && utils.indexOf(this.cells, clickedCell);
        var clickedCellElem = clickedCell && clickedCell.element;
        this.dispatchEvent("staticClick", event, [ pointer, clickedCellIndex, clickedCellElem ]);
    };
    // -----  ----- //
...
(function(window, factory) {
    ...
    if (typeof define == "function" && define.amd) {
        // AMD
        define([ "flickity/js/index", "imagesloaded/imagesloaded", "fizzy-ui-utils/utils" ], function(Flickity, imagesLoaded, utils) {
            return factory(window, Flickity, imagesLoaded, utils);
        });
    } else if (typeof exports == "object") {
        // CommonJS
        module.exports = factory(window, require("flickity"), require("imagesloaded"), require("fizzy-ui-utils"));
    } else {
        // browser global
        window.Flickity = factory(window, window.Flickity, window.imagesLoaded, window.fizzyUIUtils);
    }
    ...
    Flickity.prototype.imagesLoaded = function() {
        ...
        function onImagesLoadedProgress(instance, image) {
            ...
            var cellElem = cell && cell.element || utils.getParent(image.img, ".flickity-slider > *");
